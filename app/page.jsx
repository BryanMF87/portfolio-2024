  ...
  return (
    <div className="bg-ccOffBlack disable-scroll">
        <section id="home" className="relative z-10 flex justify-center items-center h-max px-6 md:px-0 lg:max-w-8xl lg:mx-auto">
          ...
          <p className="absolute top-2/3 -left-14 shrink-0 transform rotate-90 text-ccGray2 font-bold tracking-tight hidden md:block md:text-4xl lg:text-5xl lg:-left-[5.25rem]">Hello World</p>

          <div className="flex flex-col mt-24 md:pt-0 md:mt-32">

            <div className="relative z-20 flex justify-center">
              <div className="absolute z-[-2] w-80 h-32 -mt-6 md:-mt-10">
                <span className="absolute top-4 left-20 text-stroke-gray text-3xl lg:text-4xl lg:top-4 lg:left-12">Let</span>
                <span className="absolute bottom-2 text-stroke-gray text-4xl lg:text-5xl lg:-bottom-6 lg:-left-10">else&#123; &#125;</span>
              ...
              <div className="absolute z-[-3] w-80 h-32 -mt-6 md:-mt-10">
        ...
        <section id="about" className="relative py-40 px-6 sm:px-12 md:px-20 lg:px-40 lg:max-w-8xl lg:mx-auto">
          ...
          <h2 className="text-center text-[1.5rem] leading-10 text-ccOffWhite md:text-[1.55rem] md:leading-normal">Hi there I'm Bryan, a world-traveling digital creative, specializing in <span className="text-ccHighlight">frontend web development for businesses looking to grow and modernize.</span> I will turn your ideas into reality by connecting your message to your clients in a meaningful, visual way.</h2>
