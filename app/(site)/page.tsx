...
const Home = async () => {
  ...
  const {projectCategory} = useContext(ProjectContext);

  return (
    <div className="text-center">
        <section id="home" className="bg-slate-50">
          <div className="font-bold pt-32 pb-24 max-w-5xl mx-auto md:flex md:place-content-around md:px-6">
            <div className="md:text-left md:w-2/3">
              <h1 className="text-5xl">Gary Fink</h1>
              <h2 className="mt-6 mb-10 mx-auto px-6 text-4xl max-w-2xl md:px-0 md:mx-0 md:text-5xl">Your go-to digital artist for <span className="text-emerald-400">animation</span> and <span className="text-emerald-400 animate-bounce">motion graphics</span></h2>
              <a href="#contact" className="group relative py-4 px-8 mx-auto overflow-hidden rounded-lg bg-black text-lg shadow md:mx-0">
                <div className="absolute inset-0 h-0 bg-white group-hover:h-full"></div>
                <span className="relative text-white group-hover:text-black">Let's get started</span>
              </a>
            </div>
            <Image 
              src="/loop-animation.gif" 
              alt="looping character animation" 
              width={200} 
              height={200} 
              className="mt-10 mx-auto md:w-1/3 md:w-[300] md:h-[300]"
            />
          </div>
        </section>
        ...
        <section id="work" className="">
          ...
          <div className="relative">
            ...
            <div className="relative grid grid-cols-3 items-center justify-center saturate-0 py-20 px-6 mx-auto gap-5 sm:grid-cols-6 md:gap-7 lg:max-w-5xl">
        ...
        <section id="about" className="bg-slate-50		 py-36 px-6 mt-12 mb-36">
          <div className="max-w-4xl mx-auto flex flex-col gap-8 md:flex-row">
            ...
            <div className="flex flex-col gap-4 text-center md:text-left md:justify-center">
              <h2 className="text-4xl font-bold">Gary Fink</h2>
              ...
              <div className="flex flex-col gap-7 md:flex-row md:items-center">
                <a href="/" className="group relative py-4 px-12 mx-auto overflow-hidden rounded-lg bg-black text-lg shadow md:mx-0">
                  <div className="absolute inset-0 h-0 bg-white group-hover:h-full"></div>
                  <span className="relative text-white font-bold group-hover:text-black">Resume</span>
                </a>
