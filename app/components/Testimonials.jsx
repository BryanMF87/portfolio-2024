                ...
                {testimonialData.map((testimonial,index) => (
                    <SwiperSlide key={index}>
                        <div className="md:flex md:gap-10 md:w-[35rem] md:mx-auto">
                            ...
                            />
                            <div className="relative font-medium text-center mt-10 mb-14 md:text-left">
                                <p className={`${openSans.className} absolute top-0 left-0 z-[-1] font-bold text-9xl text-ccGray2`}></p>
                                ...
                                <p className="absolute bottom-[-2rem] right-0 z-[-1] font-bold text-9xl text-ccGray2 leading-10">"</p>
                            </div>
                        </div>
                    </SwiperSlide>
                ))}
